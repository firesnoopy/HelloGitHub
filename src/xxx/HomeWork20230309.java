...
public class HomeWork20230309 {
	public static void main(String[] args) {
	    ...
	    double n = 5 ;
	    double nn = n * n * PI ;
	    System.out.println("第四題:半徑為5的圓面積為" +nn + "圓周長為" + n * 2 * PI);
	    /*某人在銀行存入150萬，銀行利率為2%，如果每年利息都繼續存入銀行，請用程式計算10年後，本
	    金加利息共有多少錢 (用複利計算，公式請自行google)*/
	    int money = 1500000;
	    double rate = 0.02;
	    double total = money*Math.pow(1+rate,10);
	    System.out.println("第五題:10年後本金加利息有" + total);
...
//		int a = 53;
//		char b = (char)a ;
//		System.out.println("結果為" + b + "  不知道上述程式碼表示char'5'轉十進位整數=53對不對" );
